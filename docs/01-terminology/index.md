...
## 12. 市场参与者：机构 (Institutions)

### 什么是机构？

在交易市场中，"机构"是指任何从事交易的公司或组织。理解不同类型的机构对于理解市场动态至关重要。

![市场机构类型](../images/01%20Terminology/slide21_image1.png)

> **主要机构类型：**
>
> **左侧列出了主要机构类型：**
> - **银行（Banks）** - 如Goldman Sachs、Bank of America等，提供流动性和大宗交易
> - **对冲基金（Hedge funds）** - 采用各种策略追求绝对收益
> - **高频交易公司（HFT firms）** - 使用算法进行极短时间内的频繁交易
> - **养老基金（Pension funds）** - 如CalPERS，管理退休人员资产，注重长期稳定
> - **共同基金（Mutual funds）** - 如Fidelity，集合多个投资者资金进行专业化管理
> - **大型个人交易者（Large individual traders）** - 资金规模达到机构级别的个人投资者
>
> **理解机构行为的重要性：**
> - 机构订单往往决定市场方向
> - 机构的进出点通常是重要的支撑阻力位
> - 识别机构行为有助于判断趋势强度和潜在反转点
